...
public class KafkaEmbeddedServer {
    ...
    public KafkaEmbeddedServer(String zkConnection) {
        this(zkConnection, new Properties());
    }

    public KafkaEmbeddedServer(String zkConnection, Properties baseProperties) {
        this(zkConnection, baseProperties, Collections.singletonList(-1));
    }

    public KafkaEmbeddedServer(String zkConnection, Properties baseProperties, List<Integer> ports) {
    ...
    private KafkaServer startBroker(Properties props) {
        Option<String> threadName = new Some<String>("thread1");
        KafkaServer server = new KafkaServer(new KafkaConfig(props), new SystemTime(), threadName);
        server.startup();
        return server;
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("KafkaEmbeddedServer{");
